...
export const SetSizeArea = (props:SetSizeAreaProps) => {
  const classes = useStyles()
  const [index, setIndex] = useState(0),
  [size, setSize] = useState(''),
  [quantity, setQuantity] = useState(0)

const inputSize = useCallback((event:any) => setSize(event.target.value), [setSize])
const inputQuantity = useCallback((event:any) => setQuantity(event.target.value), [setQuantity])
